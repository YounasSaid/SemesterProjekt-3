...
public class ProfileController : ControllerBase
{
    ...
    public async Task<IActionResult> UpdatePassword([FromBody] UpdatePasswordRequest request)
    {
        ...
        try
        {
            // STEP 1: Hent bruger fra DataServer for at få passwordHash
            ...
            // STEP 2: Verificer currentPassword (BCrypt verification i AppServer!)
            ...
            // STEP 3: Hash det nye password
            var newPasswordHash = _hasher.Hash(request.NewPassword);

            // STEP 4: Opdater password i DataServer
